...
namespace Nyx {
	...
	void Application::createInstance() {
		...
		appInfo.pApplicationName = "Project Nyx";
		appInfo.applicationVersion = VK_MAKE_VERSION(0, 1, 0);
		appInfo.pEngineName = "Nyx";
	...
	VkSurfaceFormatKHR Application::chooseSwapSurfaceFormate(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
	...
	void Application::createSwapChain() {
		...
		VkSurfaceFormatKHR surfaceFormat = chooseSwapSurfaceFormate(swapChainSupport.formats);
	...
	void Application::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
		...
		VkClearValue clearColor = { {{0.25f, 0.0f, 0.5f, 1.0f}} };
